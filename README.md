...
混沌奇点（以下简称TCN）规则主要目的在于提供一个相对~~dnd和GURPS~~轻度容易上手的且相对泛用的偏向新怪谈风格的奇幻or软科幻 **探索向** TRPG规则。其核心设计思想在于尽量将各种内容模块化，减少数值之间的互相干涉，最后在检定的时候尽量统合到*加权*计算上去，具体内容见[检定方式](基础规则/检定方式.md)。

TCN规则适用于含主观唯心成分的探索向世设，或者在去掉奇术部分后也可适用于唯物世界。

<details>
<summary>吐槽</summary>
其实这个规则主要目的是为了比较方便快捷的开始一场有解谜有剧情能战斗理论上想干什么就能干什么的超级自由烂梗口胡故事？！你问我为什么不玩无限，那我就要说那十几个版本和几千页资源书了。至于叙事规则，现在叙事规则都和世设绑定太紧了，但是本质都是FATE，PBTA，2d6，2d10之类的系统换皮。总之作者是想做一个在“我有个点子！”的时候可以快速从一堆并不算多的规则和设定里组合一下再调整一下数值就能开始写模组然后开玩的东西。所以，这个项目里的一切都不重要，重要的是你和你的朋友们想要个什么故事，然后在这里找合适的素材开始构建。嗯，一切仅供参考。
</del>。
</details>  
<br>
...
扩展宇宙github组织地址：
https://github.com/The-Chaos-Node-Expanded-Universe
...
4. 作者这边在收到请求后在最迟一周内会给拉入扩展宇宙组织合作者。
5. 进入组织页面，创建你的项目并上传。
8. 作者会简略审核项目，如果有问题会告知，如果没有问题，作者将会在TCN项目中添加你的项目简介和链接。
9. 你会在unfinished和main分支里看到你的内容的简介和链接。

目前已有模组和故事文件夹和对应目录结构，未来将会添加扩展资源，扩展规则，其他同人创作等。
